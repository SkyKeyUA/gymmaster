(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".brands-slider__slider")) new core(".brands-slider__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 5,
        ...
        da.init();
        if (isMobile.any()) {
            let menuParents = document.querySelectorAll(".menu-page__item>a");
            ...
            let menuParents = document.querySelectorAll(".menu-page__item");
            for (let index = 0; index < menuParents.length; index++) {
                const menuParent = menuParents[index];
        ...
        let script_slideToggle = (target, duration = 500) => {
            if (!target.classList.contains("_slide")) {
                target.classList.add("_slide");
                if ("none" === window.getComputedStyle(target).display) return script_slideDown(target, duration); else return script_slideUp(target, duration);
            }
        };
        const menuPageIcon = document.querySelector(".menu-page__icon");
        const menuPageBody = document.querySelector(".menu-page__body");
        menuPageIcon.addEventListener("click", (function(e) {
            menuPageIcon.classList.toggle("menu-open");
            script_slideToggle(menuPageBody);
        }));
        ...
        searchSelect.addEventListener("click", (function(e) {
            ...
            script_slideToggle(categoriesSearch);
        }));
        ...
        if (isMobile.any()) {
            ...
            filterTitle.addEventListener("click", (function(e) {
                ...
                script_slideToggle(filterTitle.nextElementSibling);
            }));
        }
        window["FLS"] = true;
        isWebp();
